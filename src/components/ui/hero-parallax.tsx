...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] pb-24 overflow-hidden bg-primary antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto min-h-[90vh]  flex flex-col justify-center   px-4 w-full z-[999] text-secondary left-0 top-0">
